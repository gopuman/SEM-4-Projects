...
<html>
    ...
    <h1><u>Practice Mode</u><h1>
            <form id = "form" method = "post" action = "animal.php">
    ...
    <?php
        ...
        $q = "SELECT * FROM animal_cat where animal = '$animal'";
        ...
        if($count == 1)
        {
            ...
            mysqli_query($con,$q);
            echo "The animal you entered is in the database :)";
        }
        else
        {   
            $q = "INSERT INTO points values(-5)";
            mysqli_query($con,$q);
            echo "The animal you entered is not in the database :(";
        }
    }
