...
<html>
    ...
    <h1><u>Practice Mode</u><h1>
            <form id = "form" method = "post" action = "thing.php">
    ...
    <?php
        ...
        $q = "SELECT * FROM things_cat where thing = '$thing'";
        ...
        if($count == 1)
        {
            ...
            mysqli_query($con,$q);
            echo "The thing you entered is in the database :)";
        }
        else
        {   
            $q = "INSERT INTO points values(-5)";
            mysqli_query($con,$q);
            echo "The thing you entered is not in the database :(";
        }
    }
    ?>
    <script>
